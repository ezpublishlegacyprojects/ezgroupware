...
{if $methods[methods].static}static method {/if} 
    {$methods[methods].function_name}</span>&nbsp;&nbsp;<span class="smalllinenumber">[line {if $methods[methods].slink}{$methods[methods].slink}{else}{$methods[methods].line_number}{/if}]</span>

</div>
<br />

	<div class="function">
    <table border="0" cellspacing="0" cellpadding="1"><tr><td class="code-border">
    <table border="0" cellspacing="0" cellpadding="2"><tr><td class="code">&nbsp;
		<code>
{if $methods[methods].static}static {/if} 
